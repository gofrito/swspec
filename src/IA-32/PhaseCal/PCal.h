...
class PCal {
   ...
   public:
       ...
       */
      virtual uint64_t getFinalPCal(Ipp32fc* out) = 0;
       ...
       * @param  sampleoffset
       */
      bool extractAndIntegrate_reference(Ipp32f const* data, const size_t len, Ipp32fc* pcalout, const uint64_t sampleoffset);
